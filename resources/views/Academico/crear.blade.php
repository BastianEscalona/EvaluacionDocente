...
<div class="container">
          <a  class="btn btn-link" href ="{{url('Academico')}}" > <i class="fas fa-home" style="font-size: 48px;" > </i>  </a>

<form action="{{ url('/Academico')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
